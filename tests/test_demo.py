...
from config import API_KEY_SETUP_INSTRUCTIONS, TEST_SOURCE_DIR, DEFAULT_OUTPUT_DIR, DEFAULT_OUTPUT_FILE
...
def main():
    ...
    try:
        ...
        if results:
            ...
            output_file = get_unique_output_filename(DEFAULT_OUTPUT_DIR, DEFAULT_OUTPUT_FILE)
