...
from config import DEFAULT_OUTPUT_FILE, GEMINI_API_KEY_URL
...
def show_sample_results():
    ...
    print(
        "Source files will remain unchanged, and renamed copies will be created in the output/ directory.\n"
    )
